...
try {
    ...
    && isset($_POST['p_grissyProductoEmp']) && isset($_POST['p_grissyPersonal']) && isset($_POST['p_grissyProveedor'])) {
        ...
        echo json_encode(editarPermisos($idpersonal,$p_grissyVenta,$p_grissyArea,$p_grissyCliente,$p_grissyConfiguraciones,$p_grissyProductoEmp,$p_grissyPersonal,$p_grissyProveedor));
    }else {
