                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 order-md-1 order-last">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-4"> <button class="btn btn-outline-success " data-bs-toggle="modal" type="button" onclick="proveedor.en_guardar()" data-bs-target="#agregarProveedor"><i class="fa-solid fa-plus"></i> Agregar</button>
                                            </div>
                                        </div>

                                        <p class="text-subtitle text-muted">Registro de Proveedores</p>
                                    </div>
                                    <div class="col-12 col-md-6 order-md-2 order-first">
                                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page"><a href="proveedor.php">Proveedores</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel1">Proveedor</h5>
                    <div class="row">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="esDocumento" id="dni" value="dni" onclick="proveddor.oninputDni_Ruc()" checked>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="docIdentidad" class="form-control " placeholder="Doc Identidad" onchange="proveedor.validarCantidades();" oninput="proveedor.consultarDocIdentidad();">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" id="telefono" class="form-control " placeholder="Telefono" onchange="proveedor.validarTelefono()">
                            </div>
                        </div>
                    </div>
                    <div class="row">
