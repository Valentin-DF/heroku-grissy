...
<head>
    ...
    <title>Grissy - Operaciones Externas</title>
                ...
                <div class="container-xl px-4 mt-4">
                    ...
                    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                        <div class="me-4 mb-3 mb-sm-0">
                            <h1 class="mb-0"> Registro de Operaciones</h1>
                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row ">
                                <div class="me-4 mb-3 mb-sm-0">
                                    ...
                                    Lista General de Operaciones
                                </div>
                                <div class="border-0 shadow">
                                    <button class="btn btn-outline-success  btn-sm " data-bs-toggle="modal" type="button" onclick="operaciones_externas.en_guardar()" data-bs-target="#agregarArea">
                        ...
                        <div class="card-body">
                            <table summary="Lista Operaciones" class="table " id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Codigo</th>
                                        <th>Nombre</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="codigo" class="form-control " placeholder="Descripcion">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="idproducto">Operacion</label>
                                <select class="form-control form-select" id="idproducto">
                                    <option class="text-blue" value="0">Deudas de prestamo</option>
                                    <option class="text-blue" value="1">Deudas de pago al proveedor</option>
                                    <option class="text-blue" value="2">Otros Ingresos</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <button type="button" class="btn btn-outline-primary" id="editar" onclick="ingresoCaja.editarIngresoCaja()">
                            <em class="bx bx-x d-block d-sm-none"></em>
                            <span class="d-none d-sm-block">Editar</span>
                        </button>
                        <button type="button" class="btn btn-outline-primary" id="guardar" onclick="ingresoCaja.guardarIngresoCaja()">
                            <em class="bx bx-x d-block d-sm-none"></em>
...
<script src="scripts/operaciones_externas.js"></script>
<script type="text/javascript">
    $(document).ready(function() {

        operaciones_externas.obtenerListaArea();
