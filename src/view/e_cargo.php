...
<body class="nav-fixed">
                ...
                <div class="container-xl px-4 mt-4">
                    ...
                    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                        <div class="me-4 mb-3 mb-sm-0">
                            <h1 class="mb-0"> Registro de cargos</h1>
                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row ">
                                <div class="me-4 mb-3 mb-sm-0">
                                    ...
                                    Lista General de cargos
                                </div>
                                <div class="border-0 shadow">
                                    <button class="btn btn-outline-success  btn-sm " data-bs-toggle="modal" type="button" onclick="cargo.en_guardar()" data-bs-target="#agregarCargo">
                        ...
                        <div class="card-body">
                            <table summary="Lista Cargo" class="table " id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Codigo</th>
                                        <th>Nombre</th>
    ...
    <div class="modal fade text-left" id="agregarCargo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" data-bs-backdrop="stactic" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-4">
                            <div class="form-check form-check-solid">
                                <input class="form-check-input" type="radio" name="opcion" id="principal" value="Principal" checked  >
                                <label class="form-check-label" for="principal"> Principal </label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-check form-check-solid">
                                <input class="form-check-input" type="radio" name="opcion" id="secundario" value="Secundario">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-outline-primary" id="editar" onclick="cargo.editarCargo()">
                        <em class="bx bx-x d-block d-sm-none"></em>
                        <span class="d-none d-sm-block">Editar</span>
                    </button>
                    <button type="button" class="btn btn-outline-primary" id="guardar" onclick="cargo.guardarCargo()">
                        <em class="bx bx-x d-block d-sm-none"></em>
