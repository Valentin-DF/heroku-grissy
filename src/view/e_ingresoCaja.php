...
<head>
    ...
    <title>Grissy - Ingresos Cajas</title>
                ...
                <div class="container-xl px-4 mt-4">
                    ...
                    <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                        <div class="me-4 mb-3 mb-sm-0">
                            <h1 class="mb-0"> Registro del Efectivo en Caja</h1>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row ">
                                ...
                                <div class="border-0 shadow">
                                    <button class="btn btn-outline-success  btn-sm " data-bs-toggle="modal" type="button" onclick="ingresoCaja.en_guardar()" data-bs-target="#agregarArea">
...
<script src="scripts/ingresoCaja.js"></script>
