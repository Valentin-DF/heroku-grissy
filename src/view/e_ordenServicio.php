...
<head>
  ...
  <title>Grissy - Orden de Servicio</title>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
      <div class="modal-content">
          ...
          <div class="row" style="margin-top: 10px;">
            <div class="col-sm-12">
              <div class="input-group ">
                ...
                <input type="text" class="form-control" placeholder="Nombre del producto" id="nombrePro" aria-label="text" oninput="ordenes.obtenerPorNombre(2)">
          ...
          <div class="row" style="margin-top: 10px;">
            ...
            <div class="col-sm-12">
              <div class="input-group">
                ...
                <input type="number" class="form-control" placeholder="Precio del servicio" id="precioPro" aria-label="text" > 
        ...
        <div class="modal-footer justify-content-center">
          ...
          <button type="button" class="btn btn-outline-primary" id="guardar" onclick="ordenes.guardarOrdenes(2)">
            <em class="bx bx-x d-block d-sm-none"></em>
            <span class="d-none d-sm-block">Guardar</span>
          </button>
        </div>
